...
namespace ChatBot_Net5.Systems
{
    ...
    public class SystemsController
    {
        ...
        protected StatisticsSystem Stats { get; set; }
        protected CurrencySystem Currency { get; set; }
        protected CommandSystem Command { get; set; }
        ...
        public SystemsController(string BotUserName = "", Action<string> SendMsgCallback = null)
        {
            ...
            DataManage.OnSaveData += DataManage.SaveData;

            LocalizedMsgSystem.SetDataManager(DataManage);
            CallbackSendMsg = SendMsgCallback;
        }
        ...
        public void ManageDatabase()
        {
            ...
            else if (OptionFlags.ManageUsers)
            {
                // if ManageUsers is False, then remove users!
                Stats.ManageUsers();
            }
            ...
            else if (!OptionFlags.ManageStreamStats)
            {
