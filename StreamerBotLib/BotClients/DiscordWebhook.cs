...
namespace StreamerBotLib.BotClients
{
    public static class DiscordWebhook
    {
        ...
        internal enum AllowedMentionTypes { roles, users, everyone }

        internal class AllowedMentions
        {
            private const int max_data = 100;

            [AllowNull, JsonPropertyName("parse")] public string[] Parse { get; private set; }
            [AllowNull, JsonPropertyName("roles")] public string[] Roles { get; private set; }
            [AllowNull, JsonPropertyName("users")] public string[] Users { get; private set; }
            ...
            string payloadjson = null, object file = null, Embed[] embeds = null)
        {
            ...
            [AllowNull, JsonPropertyName("content")] public string Content { get; private set; } = content?[..Math.Min(2000, content.Length)];
            [AllowNull, JsonPropertyName("username")] public string Username { get; private set; } = username;
            [AllowNull, JsonPropertyName("avatarurl")] public string AvatarUrl { get; private set; } = avatarurl;
            [AllowNull, JsonPropertyName("tts")] public bool TTS { get; private set; } = tts;
            [AllowNull, JsonPropertyName("file")] public object File { get; private set; } = file;
            [AllowNull, JsonPropertyName("embeds")] public Embed[] Embeds { get; private set; } = embeds; // WebHooks expects to remove in future API updates
            [AllowNull, JsonPropertyName("payloadjson")] public string PayloadJson { get; private set; } = payloadjson;
            [AllowNull, JsonPropertyName("allowedmentions")] public AllowedMentions AllowedMentions { get; private set; } = allowedmentions;
        }
        ...
        {
            [AllowNull, JsonPropertyName("title")] public string Title { get; private set; } = title;
            [AllowNull, JsonPropertyName("type")] public string Type { get; private set; } = type;
            [AllowNull, JsonPropertyName("description")] public string Description { get; private set; } = description;
            [AllowNull, JsonPropertyName("url")] public string URL { get; private set; } = url;
            [AllowNull, JsonPropertyName("timestamp")] public DateTime Timestamp { get; private set; } = timestamp;
            [AllowNull, JsonPropertyName("color")] public int? Color { get; private set; } = color;
            [AllowNull, JsonPropertyName("footer")] public object Footer { get; private set; } = footer;
            [AllowNull, JsonPropertyName("image")] public object Image { get; private set; } = image;
            [AllowNull, JsonPropertyName("thumbnail")] public object Thumbnail { get; private set; } = thumbnail;
            [AllowNull, JsonPropertyName("video")] public object Video { get; private set; } = video;
            [AllowNull, JsonPropertyName("provider")] public object Provider { get; private set; } = provider;
            [AllowNull, JsonPropertyName("author")] public object Author { get; private set; } = author;
            [AllowNull, JsonPropertyName("fields")] public object[] Fields { get; private set; } = fields;
        }
