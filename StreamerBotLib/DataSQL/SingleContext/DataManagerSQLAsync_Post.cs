...
namespace StreamerBotLib.DataSQL.SingleContext
{
    internal partial class DataManagerSQLAsync
    {
        ...
        internal async Task PostDataGridGUIAddRow(IDatabaseTableMeta tableMeta, IDbContextTransaction contextTransaction = null)
        {
        ...
        internal async Task<bool> PostCategory(CategoryData categoryData, IDbContextTransaction contextTransaction = null)
        {
            //using var transaction = await context.Database.BeginTransactionAsync();
        ...
        internal async Task PostCategoryStream(CategoryData categoryData, int StreamCount = 0, IDbContextTransaction contextTransaction = null)
        {
            // // using var context = BuildDataContext();
            //using var transaction = await context.Database.BeginTransactionAsync();
        ...
        internal async Task<bool> PostClip(string ClipId, DateTime CreatedAt, decimal Duration, string GameId, string Language, string Title, string Url, string fromUserId, string fromUserName, IDbContextTransaction contextTransaction = null)
        {
            bool result;
            // // using var context = BuildDataContext();
            //using var transaction = await context.Database.BeginTransactionAsync();
        ...
        internal async Task<string> PostCommand(string cmd, CommandParams Params, IDbContextTransaction contextTransaction = null)
        {
            string result;
            // // using var context = BuildDataContext();
            //using var transaction = await context.Database.BeginTransactionAsync();
        ...
        internal async Task PostCurrencyType(Models.CurrencyType currencyType, IDbContextTransaction contextTransaction = null)
        {
            // // using var context = BuildDataContext();
            //using var transaction = await context.Database.BeginTransactionAsync();
        ...
        internal async Task PostCurrencyUpdate(LiveUser User, double value, string CurrencyName, IDbContextTransaction contextTransaction = null)
        {
            // // using var context = BuildDataContext();
            //using var transaction = await context.Database.BeginTransactionAsync();
        ...
        internal async Task PostCurrencyUpdate(List<PlayGameUserWager<PlayingCardFrench, PlayingCardSuit>> Updates, string CurrencyName, IDbContextTransaction contextTransaction = null)
        {
            // // using var context = BuildDataContext();
            //using var transaction = await context.Database.BeginTransactionAsync();
        ...
        internal async Task<int> PostDeathCounterUpdate(string currCategory, bool Reset = false, int updateValue = 1, IDbContextTransaction contextTransaction = null)
        {
            // // using var context = BuildDataContext();
            //using var transaction = await context.Database.BeginTransactionAsync();
        ...
        internal async Task PostGiveawayData(string UserId, DateTime dateTime, IDbContextTransaction contextTransaction = null)
        {
            // // using var context = BuildDataContext();
            //using var transaction = await context.Database.BeginTransactionAsync();
        ...
        internal async Task PostInRaidData(LiveUser user, DateTime time, int viewers, CategoryData gamename, IDbContextTransaction contextTransaction = null)
        {
            // // using var context = BuildDataContext();
            //using var transaction = await context.Database.BeginTransactionAsync();
        ...
        internal async Task PostLearnMsgsRow(string Message, MsgTypes MsgType, IDbContextTransaction contextTransaction = null)
        {
            // // using var context = BuildDataContext();
            //using var transaction = await context.Database.BeginTransactionAsync();
        ...
        internal async Task<bool> PostMergeUserStats(string CurrUser, string SourceUser, Platform platform, IDbContextTransaction contextTransaction = null)
        {
            // // using var context = BuildDataContext();
            //using var transaction = await context.Database.BeginTransactionAsync();
        ...
        internal async Task PostNewAutoShoutUser(string UserId, Platform platform, IDbContextTransaction contextTransaction = null)
        {
            // // using var context = BuildDataContext();
            //using var transaction = await context.Database.BeginTransactionAsync();
        ...
        internal async Task PostOutgoingRaid(string HostedChannel, DateTime dateTime, IDbContextTransaction contextTransaction = null)
        {
            // // using var context = BuildDataContext();
            //using var transaction = await context.Database.BeginTransactionAsync();
        ...
        internal async Task<int> PostQuote(string Text, IDbContextTransaction contextTransaction = null)
        {
            // // using var context = BuildDataContext();
            //using var transaction = await context.Database.BeginTransactionAsync();
        ...
        internal async Task<bool> PostStream(DateTime StreamStart, string Category, IDbContextTransaction contextTransaction = null)
        {
            // // using var context = BuildDataContext();
            //using var transaction = await context.Database.BeginTransactionAsync();
        ...
        internal async Task PostStreamStat(StreamStat streamStat, IDbContextTransaction contextTransaction = null)
        {
            // // using var context = BuildDataContext();
        ...
        internal async Task PostUserCustomWelcome(LiveUser User, string WelcomeMsg, IDbContextTransaction contextTransaction = null)
        {
            // // using var context = BuildDataContext();
