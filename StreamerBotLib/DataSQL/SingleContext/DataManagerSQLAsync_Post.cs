...
namespace StreamerBotLib.DataSQL.SingleContext
{
    internal partial class DataManagerSQLAsync
    {
        ...
        internal Task PostDataGridGUIAddRow(IDatabaseTableMeta tableMeta, IDbContextTransaction contextTransaction = null)
        {
        ...
        internal Task<bool> PostCategory(CategoryData categoryData, IDbContextTransaction contextTransaction = null)
        {
            return Task.Run(async () =>
            {
                //using var transaction = await context.Database.BeginTransactionAsync();
        ...
        internal Task PostCategoryStream(CategoryData categoryData, int StreamCount = 0, IDbContextTransaction contextTransaction = null)
        {
            return Task.Run(async () =>
             {
                 // using var context = BuildDataContext();
        ...
        internal Task<bool> PostClip(string ClipId, DateTime CreatedAt, decimal Duration, string GameId, string Language, string Title, string Url, string fromUserId, string fromUserName, IDbContextTransaction contextTransaction = null)
        {
            return Task.Run(async () =>
            {
                bool result;
        ...
        internal Task<string> PostCommand(string cmd, CommandParams Params, IDbContextTransaction contextTransaction = null)
        {
            return Task.Run(async () =>
            {
                string result;
        ...
        internal Task PostCurrencyType(Models.CurrencyType currencyType, IDbContextTransaction contextTransaction = null)
        {
            return Task.Run(async () =>
            {
                // using var context = BuildDataContext();
        ...
        internal Task PostCurrencyUpdate(LiveUser User, double value, string CurrencyName, IDbContextTransaction contextTransaction = null)
        {
            return Task.Run(async () =>
            {
                // using var context = BuildDataContext();
        ...
        internal Task PostCurrencyUpdate(List<PlayGameUserWager<PlayingCardFrench, PlayingCardSuit>> Updates, string CurrencyName, IDbContextTransaction contextTransaction = null)
        {
            return Task.Run(async () =>
            {
                // using var context = BuildDataContext();
        ...
        internal Task<int> PostDeathCounterUpdate(string currCategory, bool Reset = false, int updateValue = 1, IDbContextTransaction contextTransaction = null)
        {
            return Task.Run(async () =>
            {
                // using var context = BuildDataContext();
        ...
        internal Task PostGiveawayData(string UserId, DateTime dateTime, IDbContextTransaction contextTransaction = null)
        {
            return Task.Run(async () =>
            {
                // using var context = BuildDataContext();
        ...
        internal Task PostInRaidData(LiveUser user, DateTime time, int viewers, CategoryData gamename, IDbContextTransaction contextTransaction = null)
        {
            return Task.Run(async () =>
            {
                // using var context = BuildDataContext();
        ...
        internal Task PostLearnMsgsRow(string Message, MsgTypes MsgType, IDbContextTransaction contextTransaction = null)
        {
            return Task.Run(async () =>
            {
                // using var context = BuildDataContext();
        ...
        internal Task<bool> PostMergeUserStats(string CurrUser, string SourceUser, Platform platform, IDbContextTransaction contextTransaction = null)
        {
            return Task.Run(async () =>
            {
                // using var context = BuildDataContext();
        ...
        internal Task PostNewAutoShoutUser(string UserId, Platform platform, IDbContextTransaction contextTransaction = null)
        {
            return Task.Run(async () =>
            {
                // using var context = BuildDataContext();
        ...
        internal Task PostOutgoingRaid(string HostedChannel, DateTime dateTime, IDbContextTransaction contextTransaction = null)
        {
            return Task.Run(async () =>
            {
                // using var context = BuildDataContext();
        ...
        internal Task<int> PostQuote(string Text, IDbContextTransaction contextTransaction = null)
        {
            return Task.Run(async () =>
            {
                // using var context = BuildDataContext();
        ...
        internal Task<bool> PostStream(DateTime StreamStart, string Category, IDbContextTransaction contextTransaction = null)
        {
            return Task.Run(async () =>
            {
                // using var context = BuildDataContext();
        ...
        internal Task PostStreamStat(StreamStat streamStat, IDbContextTransaction contextTransaction = null)
        {
            return Task.Run(async () =>
            {
                // using var context = BuildDataContext();
        ...
        internal Task PostUserCustomWelcome(LiveUser User, string WelcomeMsg, IDbContextTransaction contextTransaction = null)
        {
            return Task.Run(async () =>
            {
                // using var context = BuildDataContext();
