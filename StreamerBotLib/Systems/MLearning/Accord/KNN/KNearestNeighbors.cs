namespace StreamerBotLib.Systems.MLearning.Accord.KNN
{
        ...
        BaseKNearestNeighbors<KNearestNeighbors, double[], IMetric<double[]>>
    {
        ...
        public override double[] Scores(double[] input, double[] result)
        {
            ...
            {
                KDTreeNodeCollection<KDTreeNode<int>> neighbors = tree.Nearest(input, K);
            ...
            {
                KDTreeNodeCollection<KDTreeNode<Tuple<int, double>>> neighbors = weightedTree.Nearest(input, K);
