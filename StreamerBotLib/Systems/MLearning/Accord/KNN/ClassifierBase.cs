namespace StreamerBotLib.Systems.MLearning.Accord.KNN
{
            ...
            IClassifier<TInput, TClasses>
    {
        ...
        /// The output generated by applying this transformation to the given input.
        /// </returns>
        public override TClasses[] Transform(TInput[] input, TClasses[] result) => Decide(input, result);

        internal T[] Create<T>(TInput input) => new T[NumberOfClasses];

        internal T[][] Create<T>(TInput[] input) => Jagged.Create<T>(input.Length, NumberOfClasses);
        ...
        internal static T[] CreateOrReuse<T>(TInput[] input, T[] decision)
        {
