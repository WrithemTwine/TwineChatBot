...
//       distribution.
// 
namespace StreamerBotLib.Systems.MLearning.Accord.KNN
{
        ...
        where TNode : KDTreeNodeBase<TNode>, IComparable<TNode>, IEquatable<TNode>
    {
        ...
        /// <summary>
        ///   Copies the entire collection to a compatible one-dimensional <see cref="Array"/>, starting
        ///   at the specified <paramref name="arrayIndex">index</paramref> of the <paramref name="array">target
        ///   array</paramref>.
        /// </summary>
        /// 
        /// <param name="array">The one-dimensional <see cref="Array"/> that is the destination of the
        ///    elements copied from tree. The <see cref="Array"/> must have zero-based indexing.</param>
