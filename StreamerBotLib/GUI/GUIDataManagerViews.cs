...
namespace StreamerBotLib.GUI
{
    public class GUIDataManagerViews : INotifyPropertyChanged
    {
        ...
        public GUIDataManagerViews()
        {
            ...
            /// </summary>
            BanReasons = DataManager.GetBanReasonsLocalObservable().Result;
            BanRules = DataManager.GetBanRulesLocalObservable().Result;
            CategoryList = DataManager.GetCategoryListLocalObservable().Result;
            ChannelEvents = DataManager.GetChannelEventsLocalObservable().Result;
            Clips = DataManager.GetClipsLocalObservable().Result;
            Commands = DataManager.GetCommandsLocalObservable().Result;
            CommandsUser = DataManager.GetCommandsUserLocalObservable().Result;
            Currency = DataManager.GetCurrencyLocalObservable().Result;
            CurrencyType = DataManager.GetCurrencyTypeLocalObservable().Result;
            CustomWelcome = DataManager.GetCustomWelcomeLocalObservable().Result;
            Users = DataManager.GetUsersLocalObservable().Result;
            UserStats = DataManager.GetUserStatsLocalObservable().Result;
            Followers = DataManager.GetFollowersLocalObservable().Result;
            GameDeadCounter = DataManager.GetGameDeadCounterLocalObservable().Result;
            GiveawayUserData = DataManager.GetGiveawayUserDataLocalObservable().Result;
            InRaidData = DataManager.GetInRaidDataLocalObservable().Result;
            LearnMsgs = DataManager.GetLearnMsgsLocalObservable().Result;
            ModeratorApprove = DataManager.GetModeratorApproveLocalObservable().Result;
            MultiChannels = DataManager.GetMultiChannelsLocalObservable().Result;
            MultiLiveStreams = DataManager.GetMultiLiveStreamsLocalObservable().Result;
            MultiWebhooks = DataManager.GetMultiWebhooksLocalObservable().Result;
            MultiSummaryLiveStreams = DataManager.GetMultiSummaryLiveStreamsLocalObservable().Result;
            OldFollowUsers = DataManager.GetOldFollowUsersLocalObservable().Result;
            OutRaidData = DataManager.GetOutRaidDataLocalObservable().Result;
            OverlayServices = DataManager.GetOverlayServicesLocalObservable().Result;
            OverlayTicker = DataManager.GetOverlayTickerLocalObservable().Result;
            Quotes = DataManager.GetQuotesLocalObservable().Result;
            ShoutOuts = DataManager.GetShoutOutsLocalObservable().Result;
            StreamStats = DataManager.GetStreamStatsLocalObservable().Result;
            Webhooks = DataManager.GetWebhooksLocalObservable().Result;
