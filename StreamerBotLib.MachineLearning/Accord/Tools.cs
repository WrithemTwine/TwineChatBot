...
namespace StreamerBotLib.MachineLearning.Accord
{
    ...
    public static partial class Tools
    {
        ...
        {
            return Vector.Scale(x, (IRange<int>)from, (IRange<int>)to);
        }
        ...
        {
            return Vector.Scale(x, (IRange<float>)from, (IRange<float>)to);
        }
