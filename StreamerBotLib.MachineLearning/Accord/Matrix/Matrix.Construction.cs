...
namespace Accord.AMath
{
    ...
    public static partial class Matrix
    {
        ...
        {
            return Accord.AMath.Jagged.Diagonal(values);
        }
        ...
        {
            return Accord.AMath.Jagged.Diagonal<T>(size, value);
        }
...
#pragma warning restore 0618
        ...
        {
            return Accord.AMath.Vector.Random(size, minValue, maxValue);
        }
        ...
        {
            return Accord.AMath.Vector.Create(values);
        }
        ...
        {
            return Accord.AMath.Vector.Create(n, value);
        ...
        {
            return Accord.AMath.Vector.Interval(a, b, (double)increment);
        }
        ...
        {
            return Accord.AMath.Vector.Interval(a, b, points);
        }
        #endregion
        ...
        {
            if (from > to)
                return Accord.AMath.Vector.Range(from - 1, to - 1);
            return Accord.AMath.Vector.Range(from, to);
        }
        ...
        {
            return Accord.AMath.Vector.Range(0, to);
        }
        ...
        {
            return Accord.AMath.Vector.Interval(from, to);
        }
        ...
        {
            return Accord.AMath.Vector.Interval(from, to, stepSize);
        }
        ...
        {
            return Accord.AMath.Vector.Interval(from, to, (float)stepSize);
        }
        ...
        {
            return Accord.AMath.Vector.Interval(range, steps);
        }
        ...
        {
            return Accord.AMath.Vector.Interval(from, to, steps);
        }
        ...
        {
            double[] x = Accord.AMath.Vector.Interval(rowMin, rowMax, rowStepSize);
            double[] y = Accord.AMath.Vector.Interval(colMin, colMax, colStepSize);
        ...
        {
            int[] x = Accord.AMath.Vector.Interval(rowMin, rowMax);
            int[] y = Accord.AMath.Vector.Interval(colMin, colMax);
        ...
        {
            double[] x = Accord.AMath.Vector.Interval(rowMin, rowMax, rowSteps);
            double[] y = Accord.AMath.Vector.Interval(colMin, colMax, colSteps);
            double[][] mesh = Matrix.Cartesian(x, y);
            return mesh;
        }
        ...
        {
            double[] x = Accord.AMath.Vector.Interval(rowRange, rowSteps);
            double[] y = Accord.AMath.Vector.Interval(colRange, colSteps);
            double[][] mesh = Matrix.Cartesian(x, y);
            return mesh;
        }
        ...
        {
            double[] x = Accord.AMath.Vector.Interval(rowRange, rowStepSize);
            double[] y = Accord.AMath.Vector.Interval(colRange, colStepSize);
            double[][] mesh = Matrix.Cartesian(x, y);
            return mesh;
        }
