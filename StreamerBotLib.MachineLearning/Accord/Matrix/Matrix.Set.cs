    ...
    public static partial class Matrix
    {
            ...
            T[,] src, int[] srcRowIndices, int[] srcColumnIndices)
        {
            ...
            if (srcRowIndices == null)
                srcRowIndices = Accord.AMath.Vector.Range(0, src.Rows());

            if (srcColumnIndices == null)
                srcColumnIndices = Accord.AMath.Vector.Range(0, src.Columns());

            if (dstRowIndices == null)
                dstRowIndices = Accord.AMath.Vector.Range(0, dst.Rows());
            if (dstColumnIndices == null)
                dstColumnIndices = Accord.AMath.Vector.Range(0, dst.Columns());
